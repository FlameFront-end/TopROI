...
swiper.on('slideChange', function() {
    ...
    const textConstruction = document.querySelector('.our-objects__text-construction');
    let slideText = '';
    ...
    switch (activeSlideIndex) {
        case 0:
            ...
            break;
        case 1:
            slideText = 'Строительства двух одноцепных ВЛ 110 кВ Певек — Билибино, протяженностью 595 км';
            break;
        case 2:
